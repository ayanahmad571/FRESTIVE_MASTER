      ...
      <div class="main-content">
        <section class="section">
          <div class="section-header">
            <h1>Virtual Booths - Others</h1>
          </div>
<div class="row" style=""> 
<div class="col-12">
                <div class="card">
                <form action="other_booths" method="get">
                  <div class="card-body">
                    <div class="form-group row mb-0">
                      ...
                      <div class="col-sm-12 col-md-2 mt-2">
                        ...
                        <a href="other_booths?title="><button class="btn btn-danger">Reset</button></a>
                      </div>
                    </div>
...
vb_vbt_id = 3 and vb_valid =1 and vb_paid =1
".$s."
                  ...
                  <div class="card-body">
                    ...
                    <div class="author-box-details">
                      ...
                      <div class="float-right mt-sm-0 mt-3">
                        <a href="other_booths_page?id=<?php echo md5("SALTINGSALTINGEHEIUNOIU*****siufniue".$soc['vb_id']); ?>" class="btn"><button class="btn btn-warning">View More <i class="fas fa-chevron-right"></i></button></a>
                      </div>
                    </div>
                  </div>
            </div>
