...
getHead("Schedule");
?>
  <link rel="stylesheet" href="assets/schedule/css/s_style.css">
          ...
          <ul>
            ...
            <li class="cd-schedule__event">
              <a data-start="11:30" data-end="13:00"  data-content="event-restorative-yoga" data-event="event-4" href="#0">
                <em class="cd-schedule__name">KCL Gym</em>
              </a>
            </li>
...
?>
<!-- app script -->
  <script src="assets/schedule/js/s_util.js"></script> <!-- util functions included in the CodyHouse framework -->
  <script src="assets/schedule/js/s_main.js"></script>
