...
################3
function getForgotPasswordTemplate($url,$userCheck, $uniname){
...
<p style="font-size: 34px; line-height: 1.2; word-break: break-word; text-align: center; mso-line-height-alt: 41px; margin: 0;"><span style="font-size: 34px;"><strong>'.$uniname.' - FRESTIVE</strong></span></p>
</div>
</div>
...
<!--[if mso]><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr style="line-height:0px"><td style="padding-right: 40px;padding-left: 40px;" align="center"><![endif]--><img align="center" alt="I\'m an image" border="0" class="center fixedwidth" src="https://ibb.co/0Yzf5xP" style="text-decoration: none; -ms-interpolation-mode: bicubic; height: auto; border: 0; width: 100%; max-width: 192px; display: block;" title="I\'m an image" width="192"/>
<!--[if mso]></td></tr></table><![endif]-->
</div>
<table border="0" cellpadding="0" cellspacing="0" class="divider" role="presentation" style="table-layout: fixed; vertical-align: top; border-spacing: 0; border-collapse: collapse; mso-table-lspace: 0pt; mso-table-rspace: 0pt; min-width: 100%; -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%;" valign="top" width="100%">
<tbody>
...
<p style="font-size: 15px; line-height: 1.5; text-align: center; word-break: break-word; font-family: inherit; mso-line-height-alt: 23px; margin: 0;"><span style="color: #808389; font-size: 15px;">Looks like you\'ve forgotten your password. Don\'t worry, we\'ve got you!<br/></span></p>
</div>
</div>
<!--[if mso]></td></tr></table><![endif]-->
<!--[if mso]><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td style="padding-right: 10px; padding-left: 10px; padding-top: 10px; padding-bottom: 10px; font-family: Tahoma, sans-serif"><![endif]-->
<div style="color:#555555;font-family:Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif;line-height:1.2;padding-top:10px;padding-right:10px;padding-bottom:10px;padding-left:10px;">
<div style="line-height: 1.2; font-size: 12px; color: #555555; font-family: Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif; mso-line-height-alt: 14px;">
<p style="font-size: 14px; line-height: 1.2; word-break: break-word; text-align: center; mso-line-height-alt: 17px; margin: 0;">Simply click below to get going.</p>
</div>
</div>
<!--[if mso]></td></tr></table><![endif]-->
...
<div style="color:#555555;font-family:Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif;line-height:1.2;padding-top:10px;padding-right:10px;padding-bottom:10px;padding-left:10px;">
<div style="line-height: 1.2; font-size: 12px; color: #555555; font-family: Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif; mso-line-height-alt: 14px;">
<p style="font-size: 14px; line-height: 1.2; word-break: break-word; mso-line-height-alt: 17px; margin: 0;">If you did not request this or need more information, contact our friendly customer service team at <a href="mailto:info@studentessentials.co?subject=Customer Service" style="text-decoration: underline; color: #0068A5;" title="info@studentessentials.co">info@studentessentials.co</a></p>
</div>
</div>
<!--[if mso]></td></tr></table><![endif]-->
<!--[if (!mso)&(!IE)]><!-->
...
<div style="line-height: 1.5; font-size: 12px; font-family: Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif; color: #555555; mso-line-height-alt: 18px;">
<p style="font-size: 12px; line-height: 1.5; word-break: break-word; text-align: left; font-family: inherit; mso-line-height-alt: 18px; margin: 0;"><span style="color: #95979c; font-size: 12px;">You are recieveing this email as <a style="text-decoration: underline;" title="'.$userCheck.'">'.$userCheck.'</a> is registered at Frestive (Student Essentials).<br/></span></p>
</div>
</div>
<!--[if mso]></td></tr></table><![endif]-->
<!--[if (!mso)&(!IE)]><!-->
...
function getVerifyEmailTemplate($mailrow, $uniname){
	return '<html>
	
	<body>
		Hi, '.$mailrow['e_to_name'].'<br>
		Thank you for registering. In order to verify your account, please click on the link below.<br><br>
		After you have verified, the Student Union will approve your account following which we will be sending you a welcome email.<br><br>
		<a href="'.$mailrow['e_alt_body'].'">'.$mailrow['e_alt_body'].'</a>
	</body>
	</html>';
}

function getToApproveEmailTemplate($mailrow, $uniname){
	return '<html>
	
	<body>
		Hi, '.$mailrow['e_to_name'].'<br>
		Thank you for registering.<br>
		We have successfully verified your email. The account has now been sent to the STUDENT UNION for approval.<br>
		We will send you an email regarding their decision shortly.
		
	</body>
	</html>';
}

function getWelcomeTemplate($mailrow, $uniname){
	return '<html>
	
	<body>
		Hi, '.$mailrow['e_to_name'].'<br>
		'.$uniname.' has approved your account and can browse through our app freely.
	</body>
	</html>';
}

function getEmailVUserNotApprVBWait($mailrow, $uniname){
	return '<html>
	
	<body>
		Hi, '.$mailrow['e_to_name'].'<br>
		Your email has been verified.<br>
		Your Booth and Account are under review, We will notify you shorty regarding their status.
	</body>
	</html>';
}

function getEmailVUserApprVBWait($mailrow, $uniname){
	return '<html>
	
	<body>
		Hi, '.$mailrow['e_to_name'].'<br>
		'.$uniname.' has approved your account.<br>
		Your Booth is under review, We will notify you shorty regarding its status.
	</body>
	</html>';
}

function getUserNotApproveEmailTemplate($mailrow, $uniname){
	return '<html>
	
	<body>
		Hi, '.$mailrow['e_to_name'].'<br>
		'.$uniname.' has decided to NOT approve your account. You may contact the Administrator or Re-Register using your Univeristy Email.<br>
		Apoliges for this.
		<br><br>Regards,<br>
		Frestive
	</body>
...
function getBoothApprovedTemplate($mailrow, $uniname){
	return '<html>
	
	<body>
		Hi, '.$mailrow['e_to_name'].'<br>
		'.$uniname.' has Approved your Booth. If you have paid, your booth is live and Active.
...
function getBoothNotApprovedTemplate($mailrow, $uniname){
	return '<html>
	
	<body>
		Hi, '.$mailrow['e_to_name'].'<br>
		'.$uniname.' has decided to NOT approve your booth. Your account and Booth have not been activated. <br>You may contact the Administrator or Re-Register using your Univeristy Email.<br>
		Apoliges for this.<br>
		If you wish to re-register, please use a different email.
		<br><br>Regards,<br>
		Frestive
	</body>
	</html>';
...
$getModules  = mysqlSelect("SELECT * FROM `ui_modules` m 
...
<head>
  ...
  <title><?php echo $name ?> - <?php echo BRANDING_COMPANY_NAME ?> for <?php echo UNI_NAME ?></title>
	...
	?>
      <footer style="background-color:#f4f6f9" class="main-footer">
        <div class="footer-left">
          Copyright &copy; 2020 <div class="bullet"></div> Designed by <a href="http://aethnaega.com">Aethn Aega</a> Powered by <a href="https://studentessentials.co/">Student Essentials</a>
        </div>
      </footer>
   <?php   
}
      ...
      <nav id="topBarHeader" class="navbar navbar-expand-lg main-navbar">
        ...
        <ul class="navbar-nav navbar-right">
          <li class="dropdown"><a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
            <img alt="image" src="<?php echo $GLOBALS['USER_ARRAY']['lum_img_src']; ?>" class="rounded-circle mr-1">
