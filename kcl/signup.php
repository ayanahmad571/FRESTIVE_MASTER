...
<style>
.successTick{
	background-color:rgba(229,255,237,0.80);
                  ...
                  <div class="row">
                    <div class="form-group col-12">
                      ...
                      <select class="form-control selectric" name="user_type">
                        ...
                        <option value="2">Virtual Booth Owner</option>
                      </select>
                    </div>
                </div>
                <div class="row">
                    <div class="form-group col-6">
                      <label>Age</label>
                      <input type="text" class="form-control" required min="15" max="200" name="age">
                    </div>
                    <div class="form-group col-6">
                      <label>Gender</label>
				...
				if(data.trim() == "ok"){
					...
					"<div class='row'>" + 
						" <div class='text-center'>" + 
							...
							"<h5>You have sucessfully registered, you will recieve an email shortly with further instructions upon approval of your account from a member of the <?php echo UNI_NAME_SU ?>.</h5>" +
